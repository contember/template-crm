...
export const BoardColumnUI = uic('div', {
	baseClass: 'rounded-lg border bg-gray-50 text-card-foreground shadow-sm relative min-w-[240px] data-[sortable-over="item"]:bg-yellow-100 hover:shadow-md transition-all duration-200',
})
