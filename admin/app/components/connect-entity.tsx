import { Component, EntitySubTree, HasOne, SugaredUniqueWhere, useEntity, useGetEntitySubTree } from '@contember/interface'
...
export const ConnectEntity = Component<ConnectEntityProps>(
	({ entity, where, field }) => {
	...
	({ entity, where, children, field }) => {
		...
		return (
			<>
				<HasOne field={field} />
				<EntitySubTree entity={{ entityName: entity, where }}>{children}</EntitySubTree>
			</>
		)
	},
)
